...
const handleSubmit = () => {
    ...
    return (<form className="flex flex-col font-bold p-6 gap-6 items-center bg-red-600" onSubmit={handleSubmit}>
        ...
        <label htmlFor="name" className="flex gap-5 items-center">
            ...
            <input type="text" id="name" placeholder="Enter name" className="border px-6 py-3 " required/>
        </label>
        <label htmlFor="name" className="flex gap-5 items-center">
            <span  className="w-1/4">Description:</span>
            <textarea  id="name" placeholder="Enter name" className="border px-6 py-3 " required/>
        </label>
